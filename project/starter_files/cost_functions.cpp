    ...
    for (size_t c = 0; c < n_circles && !collision; ++c) {
      ...
      for (auto obst : obstacles) {
        ...
        for (size_t c2 = 0; c2 < n_circles && !collision; ++c2) {
          ...
          // obstacle/actor
	  double d_x = circle_center_x - actor_center_x;
	  double d_y = circle_center_y - actor_center_y;
          double dist = std::sqrt(d_x * d_x + d_y * d_y);  // pythagoras i.e. euclidean distance
